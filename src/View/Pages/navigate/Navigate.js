...
const items = [
  ...
  getItem("Thế giới", "sub33", <SettingOutlined />, [
    getItem("Tư liệu", "16"),
  ...
  getItem("Video", "sub4", <SettingOutlined />, [
    getItem("Thời sự", "21"),
  ...
  getItem("Podcasts", "sub5", <SettingOutlined />, [
  ...
  getItem("Kinh doanh", "sub6", <SettingOutlined />, [
    getItem("Quốc tế", "51"),
  ...
  getItem("Khoa học", "sub7", <SettingOutlined />, [
  ...
  getItem("Giải trí", "sub8", <SettingOutlined />, [
    getItem("Giới sao", "69"),
    getItem("Video", "70"),
    getItem("Nhạc", "71"),
  ...
  getItem("Thể thao", "sub9", <SettingOutlined />, [
    getItem("Bóng đá", "76"),
    getItem("Marathon", "77"),
  ...
  getItem("Pháp luật", "sub10", <SettingOutlined />, [
    getItem("Hồ sơ phá án", "86"),
    getItem("Tư vấn", "87"),
    getItem("Video", "88"),
  ]),
  getItem("Giáo dục", "sub11", <SettingOutlined />, [
    getItem("Tin tức", "89"),
  ...
  getItem("Sức khỏe", "sub12", <SettingOutlined />, [
    getItem("Tin tức", "96"),
    getItem("Tư vấn", "97"),
  ...
  getItem("Đời sống", "sub13", <SettingOutlined />, [
    getItem("Tổ ấm", "105"),
  ...
  getItem("Du lịch", "sub14", <SettingOutlined />, [
  ...
  getItem("Số hóa", "sub15", <SettingOutlined />, [
  ...
  getItem("Xe", "sub16", <SettingOutlined />, [
  ...
  getItem("Ý kiến", "sub17", <SettingOutlined />, [
    getItem("Thời sự", "130"),
    getItem("Đời sống", "131"),
  ]),
  getItem("Tâm sự", "sub18", <SettingOutlined />, [
    getItem("Chuyên gia gỡ rối", "132"),
    getItem("Hẹn hò", "133"),
  ]),
  getItem("Hài", "sub19", <SettingOutlined />, [
    getItem("Cười", "134"),
    getItem("Đố vui", "135"),
...
const Navigate = () => {
  ...
  const [navigateFixed, setNavigateFixed] = useState(false);

  const refNavigate = useRef();
  const refTimeOut = useRef();

  useLayoutEffect(() => {
    const navigateConent = refNavigate.current;
    if (navigateConent) {
      const bounding = navigateConent.getBoundingClientRect();
      const positionNavigate = bounding.top + bounding.height;
      ...
      window.addEventListener("scroll", () => {
        ...
        refTimeOut.current = setTimeout(() => {
          ...
          if (window.scrollY > positionNavigate) {
            setNavigateFixed(true);
          } else {
            setNavigateFixed(false);
          }
        }, 10);
      });
    }
  ...
  return (
    <div
      className={`container-navigate ${navigateFixed && "container-navigate-fixed"
        }`}
      ref={refNavigate}
    >
      <div className="navigate">
        {!navigateFixed ? (
          ...
          className={`icon-home-new`}
        >
          <IeOutlined />
        </div>}

        <div
          className={`link-home-new ${navigateFixed && "show-link-home-new"}`}
        >
